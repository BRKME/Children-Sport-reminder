...
class KidsScheduleNotifier:
    def __init__(self):
        ...
        self.marta_tips = [
            ...
            "Ссоры с братом или сестрой. Провоцирует, дразнит, спорит «без причины». 
            На самом деле: «Мне больно. Я не знаю, как об этом сказать». Агрессия часто — просто замаскированная тревога.",
            ...
            "Отказывается делать простое. Не хочет чистить зубы, одеваться, убирать. 
            Внутреннее сообщение: «Я вымотан. У меня нет ресурса ни на что». Детям тоже нужна пауза — не только взрослым.",
            "Дай зону ответственности (карманные деньги, выбор одежды), но не грузи взрослым.",
             "Постоянно говорит “мне скучно”. Жалуется, ходит за вами, раздражает специально. 
             Истинный смысл: «Мне не хватает связи. Обними меня». Им скучно не от безделья, а от одиночества.",
        ...
        self.arkasha_tips = [
            ...
            "Гиперактивность перед сном. Бегает, шумит, дурачится, не идёт в кровать. На самом деле говорит: «Я переутомлён. 
             Мне сложно успокоиться». Это не каприз, а перегрузка нервной системы",
            "Ссоры с братом или сестрой. Провоцирует, дразнит, спорит «без причины». 
             На самом деле: «Мне больно. Я не знаю, как об этом сказать». Агрессия часто — просто замаскированная тревога.",
            ...
            "Ведёт себя “по-детски”. Просится на руки, говорит как малыш, требует внимания. 
             На самом деле: «Мне нужно почувствовать себя в безопасности». Регрессия — это не шаг назад, а способ справиться со стрессом.",
